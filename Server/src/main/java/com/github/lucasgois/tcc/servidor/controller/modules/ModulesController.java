...
public class ModulesController {
    ...
    public ModulesController(ModulesRepository repository) {
    ...
    public ResponseEntity<Object> alterar(@PathVariable final String uuid, @RequestBody @Valid final ModuleDto body) throws SQLException {
